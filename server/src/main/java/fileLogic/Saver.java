...
public class Saver<T extends Collection<E>, E> {
        ...
        for (E obj : collection) {
            ...
            for (Field field : fields) {
                try {
                    ...
                    currentAddress.add(canonicalNameSplitted[canonicalNameSplitted.length - 1] + iter);
                    addToCollection(obj, field, currentAddress);
    ...
    private void addToCollection(Object obj, Field field, ArrayList<String> currentAddress) throws IllegalAccessException {
        ...
        {
            if (visitedObjects.contains(objValue)) {
                // Object already visited, skip field
                return;
            }

            visitedObjects.add(objValue);
            ...
            visitedObjects.remove(objValue);
        }
    }
