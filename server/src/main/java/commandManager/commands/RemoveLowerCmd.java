 ...
 * @since 1.0
 */
public class RemoveLowerCmd implements Cmd, ArgumentConsumer<LabWork>, AuthorizableCommand {
    ...
    public String getDescr() {
        return "Removes elements from collection lower than given in argument. Comparing is set by tunedInWorks. " +
